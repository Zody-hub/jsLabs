...
function thirdTask() {
    ...
    roles.forEach(e => {
        ...
        var array = getIndicesOf(e + ". ", textLines);

        array.forEach(i => {
            textLines = textLines.slice(0, i) + "\n" + textLines.slice(i);
        });
    ...
    lines = lines.filter(e => !isEmpty(e));
    ...
    roles.forEach(element => {
        ...
        lines.forEach(line => {
            ...
            if(line.includes(element)) {
                let pos = line.lastIndexOf(element);
                result += number + ") " + line.substr(pos + element.length + 2) + "\n";
